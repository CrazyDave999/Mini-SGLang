...
from minisglang.layers.moe.layer import FusedMoE
...
from minisglang.loader import default_weight_loader
...
class MixtralForCausalLM(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.model(input_ids, positions, batch, input_embeds)
